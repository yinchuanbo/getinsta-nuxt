...
DigitRoll.prototype = {
    ...
    Array.prototype.forEach.call(this.container.querySelectorAll('.num'), function (item, i) {
      ...
      if (currentNum == goalNum) { //数字没变 不处理
        ...
        for (var j = currentNum; j < goalNum + 1; j++) {
          gapStr += '<div style="font-weight:600;">' + j + '</div>'
        }
  ...
  setWidth: function (n) {
    ...
    var str = '';
    for (var i = 0; i < n; i++) {
      str += '<div class="num" style="float:left;height:100%;font-weight:600;line-height:' + this.rollHeight + 'px"><div style="font-weight:600;">0</div></div>';
    }
