    ...
    <div class="footer-text__links">
      <div class="wrapper">
        ...
        <div class="footer-text__links_column">
          ...
          <nuxt-link to="/buy-instagram-followers">Get Instagram Followers</nuxt-link>
          <nuxt-link to="/buy-auto-instagram-followers">Get Auto Instagram Followers</nuxt-link>
          <nuxt-link to="/buy-instagram-likes">Get Instagram Likes</nuxt-link>
          <nuxt-link to="/affiliate-solutions">Affiliate Program</nuxt-link>
        </div>
        <div class="footer-text__links_column">
