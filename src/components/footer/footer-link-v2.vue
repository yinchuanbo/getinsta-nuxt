    ...
    <div class="footer-text__links">
      <div class="wrapper">
        ...
        <div class="footer-text__links_column">
          ...
          <router-link to="/buy-instagram-followers">Get Instagram Followers</router-link>
          <router-link to="/buy-auto-instagram-followers">Get Auto Instagram Followers</router-link>
          <router-link to="/buy-instagram-likes">Get Instagram Likes</router-link>
          <router-link to="/affiliate-solutions">Affiliate Program</router-link>
        </div>
        <div class="footer-text__links_column">
