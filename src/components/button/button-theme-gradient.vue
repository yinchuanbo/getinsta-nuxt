...
button {
  ...
  width: 100%;
  height: 100%;
  background-image: linear-gradient(90deg, #ffb12c 0%, #ff57b6 50%, #b74aff 100%);
  ...
  &.icon-android, &.icon-windows, &.icon-ios {
    &:before {
      display: inline-block;
    }
  }
