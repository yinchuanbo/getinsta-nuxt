  ...
  methods: {
    download() {
      if (this.COMMON.isiOS()) {
        this.$ga.event('insbuy', 'buy', `newyearbanner-ios`);
        location.href
          = `https://apps.apple.com/app/apple-store/id1498558125?pt=121014724&ct=en-seo-newyearbanner&mt=8`;
      } else {
        this.$ga.event('insbuy', 'buy', `newyearbanner-adr`);
        location.href = '../../../store/apps/details?id=com.insfollower.getinsta&referrer=utm_source%3Den-seo-newyearbanner'
      }
    }
  }
};
