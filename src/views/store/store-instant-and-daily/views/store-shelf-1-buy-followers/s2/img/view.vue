    ...
    <div id="store-shelf-1-buy" class="pc">
      <div class="pc-content">
            ...
            <div v-if="!tabsIndex" key="box0" class="pc-content_main-item">
              <ul v-if="!productPkgListLoading">
                <li v-for="(pkg, i) in productPkgListFollow"
                    :key="i"
                    :class="{ 'follow': pkg['product_type'] === 2, 'like': pkg['product_type'] === 1,
        ...
        <div class="inputSelect">
          <div class="inputSelect-info"></div>
        ...
        <div class="followers-link">
          <router-link to="/">Buy Instagram Likes >></router-link>
        </div>
      </div>
    </div>
                ...
                <div v-if="noUser" class="no-user">
                  <div class="noUser-info">
                    ...
                    <div v-if="!tabsIndex" class="followers-title">
                      ...
                      <div v-if="productPkgCurrentFollow.gives[0].quantity != 0" class="followers-title_bottom">+ {{ productPkgCurrentFollow.gives[0].quantity }} Free</div>
                    </div>
