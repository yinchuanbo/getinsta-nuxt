<template>
  <div ref="mark" :class="{ 'on': animateBegin }" class="home-1-steps home__sec">
    <div class="wrapper">
      <!--h2 EN & minor-lang-->
      <h2 class="home__sec_h2 step-0">Wie man kostenlose Instagram Follower und Likes erhält?</h2>

      <p v-if="pageName === ''" class="home__sec_p step-1">
        Wir bieten unbegrenzt kostenlose Instagram Follower und Likes an. Es ist sehr einfach, mit {{ $store.state.productName }} kostenlose Instagram-Follower und -Likes zu erhalten.
      </p>
      <!--p EN AD-->
      ...
      <div class="home-1-steps__steps-container mobile">
        ...
        <div class="home-1-steps__steps-container_unit step-4">
          ...
          <div class="text">
            <h3>{{ $t('home.home-1.step-2.title') }}</h3>
            <p v-if="pageName === ''">Follower & Likes kostenlos bekommen</p>
            <p v-if="pageName === 'event-dl'">Get Real Followers & Likes</p>
          </div>
        </div>
      </div>
