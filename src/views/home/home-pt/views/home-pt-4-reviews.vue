<template>
  <div ref="mark" :class="{ 'on': animateBegin }" class="home-6-reviews home__sec pt">
    <div class="wrapper">
      <h2 class="home__sec_h2 step-0">Avaliação de Usuários</h2>
      ...
      <div class="slider-card step-2">
        <div class="card">
          ...
          >
            ...
            <p class="content">{{ unit.content }}</p>
            <p class="star-rating">
              <i></i>
              <i></i>
              <i></i>
...
<script>
import avatar0 from '../../home-v1/home-6-reviews/img/reviewer-avatar-0.png';
import avatar1 from '../../home-v1/home-6-reviews/img/reviewer-avatar-1.png';
import avatar2 from '../../home-v1/home-6-reviews/img/reviewer-avatar-2.png';
import avatar3 from '../../home-v1/home-6-reviews/img/reviewer-avatar-3.png';
      ...
      reviewList: [
        {
          ...
          content: 'Eu sou uma estudante universitário e Instagram e Twitter são as minhas redes sociais favorites. Minha história é um pouco estranha, pois eu era popular no twitter, mas não no Instagram. Graças a encontrar easygetinsta.com ao navegar pela Internet, eu pude aumentar meu número de seguidores e curtidas no Instagram sem dificuldade.'
        },
        {
          avatar: avatar2,
          author: 'Santiago',
          content: 'Funcionou. Espetacular! Eu não preciso gastar dinheiro para obter seguidores reais ou curtidas, só preciso de moedas. Mas felizmente quando eu me registrei no GetInsta, eu recebi 1000 moedas instantaneamente, e eu as usei imediatamente para ganhar curtidas.'
        },
        {
          avatar: avatar0,
          author: 'Tiago',
          content: 'Eu obtive 1000 moedas após me registrar no app e obtive likes para um de meus posts. Agora, eu quero obter mais moedas. É bem interessante.'
        }
      ],
      reviewListIndex: 0
    };
