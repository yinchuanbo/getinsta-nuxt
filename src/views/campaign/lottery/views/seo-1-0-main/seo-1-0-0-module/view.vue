...
<script>
import iconCoinSmile from '@/views/campaign/lottery/seo-1-lottery/seo-1-0-main__icon-coin-smile.svg';
import iconCoinLevel0 from '@/views/campaign/lottery/seo-1-lottery/seo-1-0-main__icon-coin-level-0.png';
import iconCoinLevel1 from '@/views/campaign/lottery/seo-1-lottery/seo-1-0-main__icon-coin-level-1.png';
import iconCoinLevel2 from '@/views/campaign/lottery/seo-1-lottery/seo-1-0-main__icon-coin-level-2.png';
import iconCoinLevel3 from '@/views/campaign/lottery/seo-1-lottery/seo-1-0-main__icon-coin-level-3.png';
import iconCoinLevel4 from '@/views/campaign/lottery/seo-1-lottery/seo-1-0-main__icon-coin-level-4.png';
import iconCoinLevel5 from '@/views/campaign/lottery/seo-1-lottery/seo-1-0-main__icon-coin-level-5.png';
import iconCoinLevel6 from '@/views/campaign/lottery/seo-1-lottery/seo-1-0-main__icon-coin-level-6.png';
