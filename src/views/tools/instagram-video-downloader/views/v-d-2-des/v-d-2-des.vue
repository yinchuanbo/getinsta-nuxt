    ...
    <div class="wrapper">
      ...
      <div class="des-container">
        <div ref="mark0" :class="{ 'on': animateBegin0 }" class="unit">
          <div class="img">
            <img src="./img/v-d-2-des-img-0.svg" alt="">
          </div>
          <div class="text">
        ...
        <div ref="mark1" :class="{ 'on': animateBegin1 }" class="unit">
          <div class="img">
            <img src="./img/v-d-2-des-img-1.svg" alt="">
          </div>
          <div class="text">
        ...
        <div ref="mark2" :class="{ 'on': animateBegin2 }" class="unit">
          <div class="img">
            <img src="./img/v-d-2-des-img-2.svg" alt="">
          </div>
          <div class="text">
...
<style lang="scss" scoped src="./v-d-2-des.scss"></style>
