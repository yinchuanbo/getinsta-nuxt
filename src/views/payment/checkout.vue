<template>
  <div class="checkout" :class="{ 'client': routerClient }">
        ...
        <div class="checkout__main">
          ...
          <div class="checkout__main_wrapper left">
            <div class="checkout__main_wrapper_container">
              <h2 class="pc"><span>{{ $t('checkout.form.title') }}</span></h2>
              ...
              <div v-show="!formLoading" class="checkout__main_form">
                ...
                <div class="pay-method">
                  ...
                  <div class="row radio-group">
                    ...
                    <!--Payssion-->
                    <label v-if="payChannelPayssion" class="radio Payssion" @click="payssionSelected()">
                      <input
                        v-model="form.field.paymentMethod"
                        type="radio"
                        name="payment-method"
                      ...
                      <i class="flag">
                        <img :src="payssionCountryVModel.countryFlag" alt="Country Flag">
                      </i>
                      <label class="radio-select payssion-el">
                        <select
                          v-model="payssionCountryVModel"
                          @change="payssionCountrySelectHandle(payssionCountryVModel)"
                        >
                          <option
                    ...
                    <div v-if="form.field.paymentMethod === 'Payssion'" class="payssion-pm">
                      <div
                        v-for="(unit, i) in payssionCountryVModel.supportedPayment"
                        :key="i" class="unit"
                        :title="unit.pmName"
                        :class="{ on: unit.pmID === payssionSupportedPaymentVModel.pmID }"
                  ...
                  <div v-if="payChannelStripe" class="radio-fieldset">
                    <div class="fieldset c-card">
                      <div class="row" :class="{ 'invalid': cardNumberError }">
                        <label id="card-number" class="stripe-filed" @click="resetStripeError"></label>
                        <i class="error">{{ cardNumberErrorMsg }}</i>
                      </div>
                      <div class="row">
                        <label class="title">{{ $t('checkout.form.ExpiryDate') }}:</label>
                        <div class="double">
                          <div class="set" :class="{ 'invalid': cardExpiryError }">
                            <label id="card-expiry" class="stripe-filed expiry" @click="resetStripeError"></label>
                            <i class="error">{{ cardExpiryErrorMsg }}</i>
                          </div>
                        </div>
                        <div class="double">
                          <div class="set" :class="{ 'invalid': cardCVCError }">
                            <label id="card-cvc" class="stripe-filed cvc" @click="resetStripeError"></label>
                  ...
                  <div
                    v-if="payChannelCreditCard && form.field.paymentMethod === 'Credit Card'"
                      ...
                      <div class="row">
                        ...
                        >
                          <div class="row" :class="classes">
                            <label>
                              <input
                                v-model="form.field.cardNumber" type="tel"
                      ...
                      <div class="row has-title">
                        ...
                        <div class="double">
                          ...
                          >
                            <div class="month" :class="classes">
                              <label>
                                <input v-model="form.field.cardExpireMonth" type="tel" placeholder="MM">
                              </label>
                              <i class="error">{{ errors[0] }}</i>
                            </div>
                          </ValidationProvider>
                          ...
                          >
                            <div class="year" :class="classes">
                              <label>
                                <input v-model="form.field.cardExpireYear" type="tel" placeholder="YYYY">
                              </label>
                              <i class="error">{{ errors[0] }}</i>
                            </div>
                          </ValidationProvider>
                        ...
                        >
                          <div class="double" :class="classes">
                            <label>
                              <input v-model="form.field.cardCVC" type="tel" placeholder="CVC">
                            </label>
                            <i class="error">{{ errors[0] }}</i>
                          </div>
                        </ValidationProvider>
                ...
                <div class="row">
                  <div class="double">
                    <ValidationProvider v-slot="{ classes, errors }" name="First Name" rules="required_lite">
                      <div class="set" :class="classes">
                        <label>
                          <input
                            v-model="form.field.firstName" type="text"
                  ...
                  <div class="double">
                    <ValidationProvider v-slot="{ classes, errors }" name="Last Name" rules="required_lite">
                      <div class="set" :class="classes">
                        <label>
                          <input
                            v-model="form.field.lastName" type="text"
                ...
                <!--Street Address-->
                <ValidationProvider
                  v-if="!payChannelStripe && form.field.paymentMethod === 'Credit Card'"
                  v-slot="{ classes, errors }"
                  name="Street Address" rules="required"
                >
                  <div class="row" :class="classes">
                    <label>
                      <input
                        v-model="form.field.address" type="text"
                ...
                <div v-if="payChannelStripe" class="row">
                  ...
                  <div class="double">
                    <ValidationProvider v-slot="{ classes, errors }" name="Country" rules="required_lite">
                      <div class="set" :class="classes">
                        <label>
                          <select
                          ...
                          >
                            <option value="" disabled>{{ $t('checkout.form.Country') }}</option>
                            <option v-for="(unit, i) in countryDB" :key="i" :value="unit[0]">
                              {{ unit[1] }}
                            </option>
                          </select>
                        </label>
                ...
                <!--Zip Code, City-->
                <div v-if="!payChannelStripe && form.field.paymentMethod === 'Credit Card'" class="row">
                  <div class="double">
                    <ValidationProvider v-slot="{ classes, errors }" name="Zip Code" rules="required_lite">
                      <div class="set" :class="classes">
                        <label>
                          <input
                            v-model="form.field.zipCode" type="text"
                  ...
                  <div class="double">
                    <ValidationProvider v-slot="{ classes, errors }" name="City" rules="required_lite">
                      <div class="set" :class="classes">
                        <label>
                          <input
                            v-model="form.field.city" type="text"
                ...
                <div v-if="!payChannelStripe && form.field.paymentMethod === 'Credit Card'" class="row">
                  <div class="double">
                    <ValidationProvider v-slot="{ classes, errors }" name="State/Province" rules="required_lite">
                      <div class="set" :class="classes">
                        <label>
                          <input
                            v-model="form.field.state" type="text"
                  ...
                  <div class="double">
                    <ValidationProvider
                      v-slot="{ classes, errors }"
                      name="Country" rules="required_lite"
                    >
                      <div class="set" :class="classes">
                        <label>
                          <select
                ...
                <ValidationProvider
                  v-if="!payChannelStripe && form.field.paymentMethod === 'Credit Card'"
                  v-slot="{ classes, errors }"
                  name="Phone" rules="required|numeric"
                >
                  <div class="row" :class="classes">
                    <label>
                      <input v-model="form.field.phone" type="text" :placeholder="$t('checkout.form.Phone')">
                    </label>
                    <i class="error">{{ errors[0] }}</i>
                  </div>
                </ValidationProvider>
                ...
                <ValidationProvider v-slot="{ classes, errors }" name="Email" rules="required|email">
                  <div class="row" :class="classes">
                    <label>
                      <input v-model="form.field.email" type="email" :placeholder="$t('checkout.form.Email')">
                    </label>
                    <i class="error">{{ errors[0] }}</i>
                  </div>
                </ValidationProvider>
          ...
          <div class="checkout__main_wrapper right">
            <div class="checkout__main_wrapper_container">
              <h2><span>{{ $t('checkout.cart.title') }}</span></h2>
                  ...
                  <div v-if="cartList.length !== 0" class="checkout__main_cart">
                    <div class="checkout__main_cart-list">
                      <div v-for="(unit, i) in cartList" :key="i" class="unit">
                        ...
                        <div class="text">
                          <!--main texts-->
                          <p v-if="unit['cycle_type'] > 1 && unit['product_type'] === 2" class="main">
                            <span>
                              {{ unit.purchase_quantity }} Followers/Day
                              | {{ $i18n.locale === 'en' ? $t('global.currencySymbol') : '' }}
                              {{ unit.price_decimal / unit.cycle_type | numToFixed }}
                              {{ $i18n.locale !== 'en' ? $t('global.currencySymbol') : '' }}
                            </span>
                          </p>
                          <p v-if="unit['cycle_type'] > 1 && unit['product_type'] === 1" class="main">
                            <span>
                          ...
                          <p v-if="!unit['cycle_type'] || unit['cycle_type'] === 1" class="main">
                            <span v-if="unit['is_coin'] !== 1">
                              ...
                              {{ unit.task_type === 2 ? displayVarFollowers : displayVarLikes }}
                              | {{ $i18n.locale === 'en' ? $t('global.currencySymbol') : '' }}
                          ...
                          <p
                            v-if="(!unit['cycle_type'] || unit['cycle_type'] === 1)
                              && unit['is_coin'] !== 1
                          ...
                          >
                            <span>
                              ...
                              {{ (unit.gives[0].type === 3 ? '+' + unit.gives[0].quantity + ' coins ' : '') }}
                            </span>
                          </p>
                          <p
                            v-if="(!unit['cycle_type'] || unit['cycle_type'] === 1)
                        ...
                        <i :title="$t('checkout.cart.delete')" @click="cartUnitDelete(i)"></i>
                      </div>
                    </div>
            ...
            <div class="checkout__main_wrapper_btn-container" @click="purchaseGate(invalid, validate)">
              <button-yellow-icon :text="$t('checkout.BuyNow')" :loading="loading" />
            </div>
    ...
    <transition name="fade">
      ...
      <div v-if="stripeIframe" key="box1" class="uni-dialog-box stripe-iframe enter-box enter-mask">
        <div class="mask"></div>
        <div class="container">
    ...
    <form
      ...
      method="post"
    >
      <input v-for="(value, key, i) in hotAntPayRequestBody" :key="i" type="hidden" :name="key" :value="value" />
    </form>
  </div>
</template>
  ...
  computed: {
    cartTotalPrice() {
      ...
      for (let i = 0; i < this.cartList.length; i++) {
        total = this.COMMON.accAdd(total, this.cartList[i].price_decimal);
      }
      return total;
    },
    displayVarLikes() {
    ...
    * */
    ...
    metaDataInit() {
      if (this.$route.path === '/checkout-2') {
        this.meta.title = `${this.$store.state.productName} ${this.$t('checkout.meta.title-0')}`;
      } else {
        this.meta.title = `${this.$store.state.productName} ${this.$t('checkout.meta.title-1')}`;
      }
    },
    ...
    initSupportedPayChannelV2(enabledPlatforms) {
      ...
      if (this.payChannelCreditCard) this.form.field.paymentMethod = 'Credit Card';
    ...
    stripeInit() {
      ...
      this.COMMON.includeStripe('js.stripe.com/v3/', function () {
    ...
    purchaseGate(invalid, validate) {
      ...
      if (this.form.field.paymentMethod === 'Payssion' && this.payssionSupportedPaymentVModel.pmID === '') {
        this.$alert(
          '', 'warn',
      ...
      if (invalid) {
        setTimeout(() => {
          this.$scrollTo('.invalid', { offset: -1 * document.getElementById('header').offsetHeight });
        }, 500);
        return;
      }
      ...
      if (this.payChannelStripe) {
        ...
        if (this.form.field.paymentMethod === 'PayPal') {
          ...
          console.error('purchaseGate: pending; Need Check purchaseGate() judgment.');
        }
      }
    },
    ...
    stripeConfirmCardPayment() {
      ...
      this.stripe.confirmCardPayment(
        self.stripePaymentIntent.clientSecret,
        {
        ...
        if (response.data.status === 'ok') {
          ...
          if (response.data.error.type === 'bad_token') {
            if (this.purchaseParams.urlCart === '1') {
              ...
              this.dialogFail = true;
              console.error(`stripeRetrievePayment Error: `, response.data.error);
            } else {
    ...
    payssionCountrySelectHandle(payssionCountryVModel) {
      ...
      this.payssionSupportedPaymentVModel = payssionCountryVModel.supportedPayment[0];
    },
    ...
    purchaseSubmitCart() {
      ...
      if (param.token !== null && param.key !== null && param.token !== undefined && param.key !== undefined) {
        api = apiTask.pay;
      } else {
    ...
    checkURLParams() {
      ...
      this.purchaseParams.urlCartType = this.COMMON.getURLQuery('url_cart_type');

      if (this.$storage.has('cartCache')
        && this.COMMON.getURLQuery('cart_cache') === '1'
      ) {
        const storedCartCache = this.$storage.get('cartCache');
        // console.log(storedCartCache);

        if (storedCartCache.order_id) this.purchaseParams.orderID = storedCartCache.order_id;
        ...
        this.cartList = storedCartCache.tasks;
        ...
        if (this.purchaseParams.urlCart === '1') {
          ...
          if (this.COMMON.getURLQuery('cart_test') === '1') {
            const cartUnitTest = {
              follow_pic_url: 'https://scontent-tpe1-1.cdninstagram.com/v/t51.2885-19/s150x150/68761814_406547376656235_6673091594033299456_n.jpg?_nc_ht=scontent-tpe1-1.cdninstagram.com&_nc_ohc=DPAB3iq90g8AX9a55Qc&oh=52514c6b4cf8eb4f0bf861be45e915e0&oe=5F07301D',
              follower_count: 124,
              following_count: 81,
              gives: [
                {
              ...
              like_pic_url: 'https://scontent-tpe1-1.cdninstagram.com/v/t51.2885-15/sh0.08/e35/c81.0.815.815a/s640x640/94188443_594411697834507_6414606497590697406_n.jpg?_nc_ht=scontent-tpe1-1.cdninstagram.com&_nc_cat=107&_nc_ohc=5ER2hTV6rA0AX81mktZ&oh=3ce2144a9a10c6fa80ed694f78c6cee2&oe=5F05F2B2',
              post_count: 204,
              price_decimal: 2,
              product_id: 105,
    ...
    checkURLCartLang() {
      ...
      if (lang === 'en' || lang === null) {
        ...
        if (langLower !== 'en') {
          ...
          this.$cookies.remove('googtrans');
          this.$cookies.remove('googtrans', '/', location.hostname);
          this.$cookies.set('googtrans', param, '30d', '/', location.hostname, false, 'Lax');
        }
      }
    ...
    gaBuyNow() {
      if (this.$i18n.locale === 'en') {
        if (this.payChannelStripe) {
          ...
          this.$ga.event('insbuy', 'buy', `checkoutbuy-${this.purchaseParams.origin}`);
        }
      } else {
        let client = '';
    ...
    payBumperEngine() {
      if (this.payBumper && this.$route.path === '/checkout') {
        this.dialogFailMsg = 'Our system is upgrading currently. Please try again later.';
        this.dialogFail = true;
