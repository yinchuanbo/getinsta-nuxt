      ...
      <div class="svg">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1920 1080">
          ...
          <g id="fortyfour" data-name="Layer 2">
            ...
            <path id="ou" class="cls-3" d="M956.54,168.2c-194.34,0-351.89,157.55-351.89,351.89S762.19,872,956.54,872s351.89-157.55,351.89-351.89S1150.88,168.2,956.54,168.2Zm0,584.49c-128.46,0-232.6-104.14-232.6-232.6s104.14-232.6,232.6-232.6,232.6,104.14,232.6,232.6S1085,752.69,956.54,752.69Z" />
          </g>
