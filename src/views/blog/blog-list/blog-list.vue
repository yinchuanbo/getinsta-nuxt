...
<script>
import Blog0Title from '@/views/blog/blog-list/views/blog-0-title';
import Blog1Content from '@/views/blog/blog-list/views/blog-1-content';
  ...
  metaInfo() {
    return {
      ...
      meta: [
        {
          name: 'description',
          content: this.$t('blog.meta.description')
        }
      ],
      link: [
        {
